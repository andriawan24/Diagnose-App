...
@section('content')
     ...
     <ol class="breadcrumb bc-3">
        ...
        <li>
            <a href="{{ route('article-category.index') }}"><i class="fa-home"></i>Kategori Artikel</a>
        </li>
        <li class="active">
            <strong>Ubah</strong>
        </li>
    ...
    <div class="panel panel-primary">
        <div class="panel-body">
            <form action="{{ route('article-category.update', encode($category->id)) }}" method="POST">
                @csrf
                @method('PUT')

                <div class="form-group">
                    <label class="control-label">Nama</label>
                    <input type="text" class="form-control" name="name" data-validate="required" value="{{ $category->name }}" placeholder="Masukan Nama Kategori" />
